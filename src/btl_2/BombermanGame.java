...
import btl_2.control.Menu;
import btl_2.control.Move;
import btl_2.entities.Entity;
import btl_2.entities.animal.Animal;
import btl_2.entities.animal.Bomber;
import btl_2.entities.block.Bomb;
import btl_2.entities.block.Portal;
import btl_2.graphics.Sprite;

import java.util.ArrayList;
import java.util.List;

import static btl_2.control.Menu.*;
import static btl_2.entities.block.Portal.*;
import static btl_2.levels.NextLevel.*;
import static btl_2.utility.SoundManager.updateSound;
...
public class BombermanGame extends Application {
    ...
    public void start(Stage stage) {
        ...
        Image author = new Image("images/back.jpg");
